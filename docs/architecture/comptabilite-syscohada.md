...
| **P3** | Facturation : factures + proformas + avoirs + allocations de paiement + PDF + conversion + génération auto d'écritures | RC-30/33 |
| **P4** | Grand livre, balances, livres caisse/banque, lettrage, rapprochement bancaire, snapshots, périodes/clôture/RAN | RC-29/30 |
| **P5** | États financiers SYSCOHADA (bilan, résultat, TAFIRE), comparatifs N/N-1, reporting, consolidation multi-sites, analytics | RC-34+ |
