...
**Adopté** (24 modales / 19 vues) : `CustomerListView`, `PaymentListView`, `SupplierListView`,
...
(création/édition), `MarketplaceListingsView` (connexion marketplace). Reste (incrémental, ~5 vues) :
OrderDetail, ProductForm, PosView, SettingsView, StockList. Contrat testé (`PaymentListView.spec.ts`,
