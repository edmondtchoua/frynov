...
> Mise à jour : 2026-06-09. Branche `release/v1.0.0` à **`v1.0.0-rc.83`** (cette session → `rc.84+`).
...
> **Catalogue complet** (rc.72→73 : Attributs, Variantes, Fiche produit, Étiquettes),
...
> **+ tracker i18n vivant** [`i18n-coverage.md`](i18n-coverage.md) — **avancement réel par vue : 44 ✅ / 0 🟡 / 4 ⬜ sur 48** (92 % ; reste 2 vues traduisibles — Inventaire — + 2 Customers exclues) — & **Definition of Done i18n** (toute vue créée/modifiée livre FR+EN).
