...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.50`** (cette session → `rc.51+`).
...
> **polish volets — Stock, Paiements, Admin & Fournisseurs** (rc.49→rc.51 : sous-titre en-tête, `.input-affix` unité/devise/%, `.input-group`).
