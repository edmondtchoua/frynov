...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.48`** (cette session → `rc.49+`).
...
> **polish volets — module Stock** (rc.49 : sous-titre en-tête + suffixe `.input-affix`).
