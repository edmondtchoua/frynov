...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.56`** (cette session → `rc.57+`).
...
> **module Inventaire traduit FR/EN** — Entrepôts (rc.55) + Stock (rc.56) + Alertes (rc.57), namespace `inventory.*`.
