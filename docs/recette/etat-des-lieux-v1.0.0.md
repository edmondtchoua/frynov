...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.51`** (cette session → `rc.52+`).
...
> **polish volets — Stock, Paiements, Admin, Fournisseurs, Entrepôts & Livraisons** (rc.49→rc.52 : sous-titre en-tête, `.input-affix` unité/devise/%, `.input-group` ; POS déjà conforme).
