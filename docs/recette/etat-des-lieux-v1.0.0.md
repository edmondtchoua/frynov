...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.49`** (cette session → `rc.50+`).
...
> **polish volets — modules Stock & Paiements** (rc.49→rc.50 : sous-titre en-tête, suffixe `.input-affix`, `.input-group`).
