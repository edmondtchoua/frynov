...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.65`** (cette session → `rc.66+`).
...
> **back-office Admin** (rc.64 liste tenants + rc.65 fiche détail + rc.66 Promotions, namespace `admin.*`).
