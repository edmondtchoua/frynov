...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.57`** (cette session → `rc.58+`).
...
> **module Inventaire traduit FR/EN** — Entrepôts (rc.55) + Stock (rc.56) + Alertes (rc.57) + Ajustements (rc.58), namespace `inventory.*`.
