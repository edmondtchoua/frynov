...
> Mise à jour : 2026-06-08. Branche `release/v1.0.0` à **`v1.0.0-rc.64`** (cette session → `rc.65+`).
...
> **back-office Admin — tenants** (rc.64 liste + rc.65 fiche détail, namespace `admin.*`).
