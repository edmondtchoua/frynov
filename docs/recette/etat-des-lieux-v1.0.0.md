...
> Mise à jour : 2026-06-09. Branche `release/v1.0.0` à **`v1.0.0-rc.76`** (cette session → `rc.77+`).
...
> **+ tracker i18n vivant** [`i18n-coverage.md`](i18n-coverage.md) — **avancement réel par vue : 35 ✅ / 0 🟡 / 13 ⬜ sur 48** (rc.70 : pagination unifiée `common.pageOf`, 26 vues câblées toutes complètes) — & **Definition of Done i18n** (toute vue créée/modifiée livre FR+EN).
